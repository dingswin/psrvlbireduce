...
gatedfitsfiles = glob.glob(r'./*[!un]gatedwide*idifits')
if len(gatedfitsfiles) == 0:
    gatedfitsfiles = glob.glob(r'./*_binbd*idifits')    
if len(gatedfitsfiles) == 0:
    gatedfitsfiles = glob.glob(r'./*[!un]gated_*idifits')    
gatedfitsfiles.sort()
if binno != -1:
    gatedfitsfiles = glob.glob(r'./*[!un]gated*BIN%d*idifits' % binno)
    if len(gatedfitsfiles) != 1:
        gatedfitsfiles = glob.glob(r'./*[!un]gated*BIN0%d*idifits' % binno)
...
for gatedfitsfile in gatedfitsfiles:
    ...
    writefile.write('UNGATED FITSFILE: VLBA_BD244D_bd244dungated_BIN0_SRC0_0_220201T230008.idifits\n')
    writefile.write('INBEAM 0 FITSFILE: VLBA_BD244D_bd244dinbeam1_BIN0_SRC0_0_220201T230532.idifits.idifits\n')
    writefile.write('INBEAM 1 FITSFILE: VLBA_BD244D_bd244dinbeam2_BIN0_SRC0_0_220201T230613.idifits.idifits\n')
    writefile.write('BANDPASS CAL: J2148+0657\n')
    writefile.write('NUMBER OF TARGETS: 1\n')
    writefile.write('TARGET 0 NAME: PULSAR\n')
    writefile.write('TARGET 0 PHSREF: J2219-0051\n')
    writefile.write('TARGET 0 INBEAM 0 NAME: J2221-0132\n')
    writefile.write('TARGET 0 INBEAM 1 NAME: J2221-0128\n')
    writefile.close()
