...
gatedfitsfiles.sort()
if binno != -1:
    gatedfitsfiles = glob.glob(r'./*[!un]gatedwide*BIN%d*idifits' % binno)
...
for gatedfitsfile in gatedfitsfiles:
    ...
    writefile.write('UNGATED FITSFILE: VLBA_BD244A_bd244aungatedrecor_BIN0_SRC0_0_220103T151456.idifits\n')
    writefile.write('INBEAM 0 FITSFILE: VLBA_BD244A_bd244ainbeam1recor_BIN0_SRC0_0_220103T151333.idifits\n')
    writefile.write('INBEAM 1 FITSFILE: VLBA_BD244A_bd244ainbeam2recor_BIN0_SRC0_0_220103T151416.idifits\n')
