...
gatedfitsfiles = glob.glob(r'./*gated*idifits')
...
for gatedfitsfile in gatedfitsfiles:
    ...
    writefile.write('UNGATED FITSFILE: VLBA_BD245B2_bd245b2gated_BIN0_SRC0_0_211206T163423.idifits\n')
    writefile.write('INBEAM 0 FITSFILE: VLBA_BD245B2_bd245b2_BIN0_SRC0_0_211206T163116.idifits\n')
    writefile.write('INBEAM 1 FITSFILE: VLBA_BD245B2_bd245b2_BIN0_SRC0_0_211206T163116.idifits\n')
    writefile.write('INBEAM 2 FITSFILE: VLBA_BD245B2_bd245b2_BIN0_SRC0_0_211206T163116.idifits\n')
    writefile.write('BANDPASS CAL: J1733-1304\n')
    writefile.write('NUMBER OF TARGETS: 1\n')
    writefile.write('TARGET 0 NAME: J1756-2251\n')
    writefile.write('TARGET 0 PHSREF: J1753-1843\n')
    writefile.write('TARGET 0 INBEAM 0 NAME: J1755-2232\n')
    writefile.write('TARGET 0 INBEAM 1 NAME: J1757-2241\n')
    writefile.write('TARGET 0 INBEAM 2 NAME: J1742-1903\n')
    writefile.close()
